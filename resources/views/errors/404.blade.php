...
<!DOCTYPE html>
<html lang="pt-br" class="ls-theme-green ls-html-nobg ls-main-full">
<head>
...
<main class="ls-main">
    ...
    <footer class="ls-footer" role="contentinfo">
      ...
      <div class="ls-footer-info">
        <p class="ls-copy-right">Copyright © 2016 Irrigation Control</p>
      </div>
    </footer>
...
<aside class="ls-notification">
  <nav class="ls-notification-list" id="ls-notification-curtain">
    ...
    <ul>
        <li class="ls-dismissable">
          <a href="#">Nisi necessitatibus vel enim sed voluptas et earum</a>
          <a href="#" data-ls-module="dismiss" class="ls-ico-close ls-close-notification"></a>
        </li>
        <li class="ls-dismissable">
          <a href="#">Beatae ullam temporibus voluptates fuga qui omnis enim et doloremque</a>
          <a href="#" data-ls-module="dismiss" class="ls-ico-close ls-close-notification"></a>
        </li>
        <li class="ls-dismissable">
          <a href="#">Nihil est aut eaque inventore ab sed laudantium debitis ut</a>
          <a href="#" data-ls-module="dismiss" class="ls-ico-close ls-close-notification"></a>
        </li>
        <li class="ls-dismissable">
          <a href="#">Quibusdam incidunt labore eos qui dolores numquam pariatur et</a>
          <a href="#" data-ls-module="dismiss" class="ls-ico-close ls-close-notification"></a>
        </li>
        <li class="ls-dismissable">
          <a href="#">In rem ipsum quis rem dolorem enim rem nulla rem deleniti iure recusandae consectetur</a>
          <a href="#" data-ls-module="dismiss" class="ls-ico-close ls-close-notification"></a>
        </li>
    </ul>
  ...
  <nav class="ls-notification-list" id="ls-help-curtain">
    ...
    <ul>
        <li><a href="#">> ut quo ut quaerat nihil neque</a></li>
        <li><a href="#">> blanditiis molestias aut culpa ut enim</a></li>
    </ul>
  </nav>
  ...
  <script src="http://assets.locaweb.com.br/locastyle/3.9.0/assets/javascripts/example.js" type="text/javascript"></script>
</body>
</html>
